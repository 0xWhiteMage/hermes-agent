...
export const zh: Translations = {
  ...
  settings: {
    ...
    localModels: {
      ...
      downloadDoneToast: model => `${model} 已下载完成，可以使用。`,
      ...
      activateDoneToast: model => `${model} 现在是您的模型——新对话将使用它。`,
      verifying: '正在校验下载…',
      ...
      pillTooBig: '超出本机内存',
      browseTitle: '发现更多模型',
      browseHint: '搜索整个 Hugging Face。在这里下载的模型和目录模型一样自动适配你的机器，但未经我们测试。',
      ...
      addedByYou: '由你添加——和这里的其他模型一样使用，但未经我们测试',
      ...
      sideloadAlreadyPresent: '该模型文件已在你的库中。',
