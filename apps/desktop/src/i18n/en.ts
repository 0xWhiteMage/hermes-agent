...
export const en: Translations = {
  ...
  settings: {
    ...
    localModels: {
      ...
      browseHint: 'Search all of Hugging Face. Anything you download here works like a catalog model — sized to your machine automatically — but has not been tested by us.',
      ...
      addedByYou: 'Added by you — works like any model here, not tested by us',
      ...
      sideloadAlreadyPresent: 'That model file is already in your library.',
