...
export const ja = defineLocale({
  ...
  settings: {
    ...
    localModels: {
      ...
      downloadDoneToast: model => `${model} のダウンロードが完了し、使用できます。`,
      ...
      activateDoneToast: model => `${model} が現在のモデルになりました——新しいチャットで使用されます。`,
      ...
      browseHint: 'Hugging Face 全体を検索できます。ここでダウンロードしたモデルもカタログのモデルと同様に自動でマシンに合わせて動作しますが、当方でのテストは行われていません。',
      ...
      sideloadAlreadyPresent: 'そのモデルファイルは既にライブラリにあります。',
