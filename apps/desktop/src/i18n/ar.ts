...
export const ar = defineLocale({
  ...
  profiles: {
    ...
    gatewaySwitcher: 'تبديل البوابة',
    gatewayLocalHeading: 'محلي',
    gatewayThisDevice: 'هذا الجهاز',
    gatewayRemoteHeading: 'بعيد',
    gatewaySshHeading: 'SSH',
    switchToGateway: name => `التبديل إلى ${name}`,
    cloudAgents: 'Hermes Cloud',
    cloudAgentsEmpty: 'لا يوجد وكلاء Hermes Cloud متاحون.',
    cloudAgentsLoading: 'جار تحميل وكلاء Hermes Cloud…',
    cloudAgentsRefresh: 'تحديث البوابات',
    switchToCloudAgent: name => `التبديل إلى ${name}`,
    starCloudAgent: name => `إضافة ${name} إلى المفضلة`,
    unstarCloudAgent: name => `إزالة ${name} من المفضلة`,
    actions: 'إجراءات',
    color: 'اللون',
    colorFor: 'اللون',
  ...
  shell: {
    ...
    gatewayMenu: {
      ...
      favorites: 'البوابات المفضلة',
      noFavorites: 'لا توجد بوابات مفضلة بعد.',
      manageFavorites: 'إدارة في الإعدادات ←',
      useFavorite: name => `الاتصال بـ ${name}`,
      activeFavorite: 'نشط',
      switchingFavorite: 'جار التبديل…'
    },
    statusbar: {
      unknown: 'غير معروف',
      restart: 'إعادة تشغيل',
